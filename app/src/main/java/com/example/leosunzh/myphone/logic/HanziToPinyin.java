//package com.example.leosunzh.myphone;
//
///**
// * Created by leosunzh on 2015/12/20.
// * 来自android4.2 源码
// * packages/providers/ContactsProvider/src/com/android/providers/contacts的HanziToPinyin.java
// * 然而并没有什么用，得到的全是空字符
// */
//
///*
...
////
////        String hanzi = "我爱我中华China";
////        Log.i("info", "汉字：" + hanzi);
////
////        String pin = getPinYin(hanzi);
////        Log.i("info", "拼音：" + pin);
////    }
////
////    /**
